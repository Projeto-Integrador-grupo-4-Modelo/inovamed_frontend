...
export function ConfirmarDeleteModal({ isOpen, onClose, onConfirm, consulta }: ConfirmarDeleteModalProps) {
            ...
            <div className="bg-white rounded-lg w-full max-w-md p-6 relative">
                ...
                <div className="space-y-4 mb-6">
                    <p className="text-gray-600">
                        Tem certeza que deseja excluir a consulta? <span className="font-semibold">{consulta.especialidade}</span>?
                    </p>
